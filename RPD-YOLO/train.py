...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5s_LCAFNet_M3FD.yaml', help='model.yaml path')
    ...
    if opt.resume and not wandb_run:  # resume an interrupted run
        ...
        # 2024/10/27 wwc 修改
        #ckpt = opt.resume if isinstance(opt.resume, str) else get_latest_run('/home/Newdisk/wwc/PythonProjects/ACFormer_184/runs/train/exp')  # specified or most recent path
